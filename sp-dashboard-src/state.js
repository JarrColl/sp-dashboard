...
export const setCachedTasks = (v) => { cachedTasks = v; };
export const setCachedProjects = (v) => { cachedProjects = v; };
export const setLatestMetrics = (v) => { latestMetrics = v; };
export const setCurrentSort = (v) => { currentSort = v; };
