...
export const updateBarChart = () => {
  ...
  if (!cfg) return;
  renderGenericBarChart(cfg.barData(latestMetrics), 'bar-chart-container', cfg.barColor, cfg.format);
};
...
export const renderGenericBarChart = (chartData, containerId, color, formatFn) => {
