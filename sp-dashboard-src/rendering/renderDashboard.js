...
export const updateDashboardUI = (metrics) => {
  ...
  const sortedEntries = sortEntries(
    metrics.tableEntries,
    currentSort.key,
    currentSort.dir,
  );

  document.getElementById("stat-time").innerText = formatTime(
    metrics.totalTimeSpent,
  );
  document.getElementById("stat-tasks").innerText = String(
    metrics.totalCompleted,
  );
  document.getElementById("stat-tasks-total").innerText =
  ...
  document.getElementById("stat-late").innerText = String(
