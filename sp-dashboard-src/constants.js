...
export const MODES = {
  PRESET: { TODAY: 'today', WEEK: 'week', MONTH: 'month', YEAR: 'year', CUSTOM: 'custom' },
  ...
  CHART: { TIME: 'time', COMPLETED: 'completed', OVERDUE: 'overdue', LATE: 'late' },
};
...
export const PIE_COLORS = [
  '#03a9f4', '#b388ff', '#4ade80', '#f472b6',
  '#fbbf24', '#f87171', '#34d399', '#818cf8', '#a78bfa',
];
